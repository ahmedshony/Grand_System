...
public class Review_ViewController implements Initializable, ViewControllerClass {
    ...
    String logo_img_param_code = "Reports/report_images/grand1.JPEG";
    ...
    @FXML
    private TableColumn<Export_Bill, Date>  export_review_date_Colo;
    ...
    @FXML
    private TableColumn<Import_Bill, Date>  import_review_date_Colo;
                ...
                if (selected_export_bill != null) {
                    ...
                    if (buttonTypeOptional.get() == ButtonType.CANCEL) {
                        ...
                        if (export_check_quantity_list.size() == 0){
                            ...
                            UIManager.showAlert("لا يمكن حذف بيانات الفاتورة بسبب عدم كفاية الكميات الحاليه في الاصناف المحددة", AlertType.error, root, 0, 0);
                            UIManager.showAlert( " الاصناف هي : " + export_check_quantity_list, AlertType.alarm, root, 0, 300);
                ...
                if (selected_import_bill != null) {
                    ...
                    if (buttonTypeOptional.get() == ButtonType.CANCEL) {
                        ...
                        if (import_company_dataManager.delete_bill(deleted_Bill).equals(QueryState.success)) {
                            ...
                            UIManager.showAlert("لا يمكن حذف بيانات الفاتورة بسبب عدم كفاية الكميات الحاليه في الاصناف المحددة", AlertType.error, root, 0, 0);
                            UIManager.showAlert( " الاصناف هي : " + import_check_quantity_list, AlertType.alarm, root, 0, 300);
    ...
    public void setup_permissions() {
        try {
            ...
            try {
                ...
                path = "D:/GRAND_BACKUPS/GRAND_" + date + ".sql";
            } catch (Exception e) {
                e.printStackTrace();
            }
            String dbUserName = "root";
            String dbPassword = "root1234";
            String dbName = "grand_system";
